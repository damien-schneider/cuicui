export const AirpodsPro = () => {
  return (
    ...
    >
      {/* Cavity */}
      <div className="-translate-x-1/2 absolute top-1/3 left-1/2 h-[20px] w-[150px] translate-y-1/3 transform rounded-full bg-linear-to-b from-neutral-300 to-white" />

      {/* Line */}
      <div className="relative mt-[30%] h-[2px] w-full bg-linear-to-r from-neutral-200 via-neutral-300 to-neutral-200">

...
export default function PreviewStaticNoise() {
  return (
    <div className="relative h-full w-full">
      ...
      <section className="font-semibold h-full w-full  bg-linear-to-t dark:to-gray-800 dark:from-gray-950 to-gray-50 from-white flex flex-col items-center justify-center dark:text-white text-black">
        <GridPattern />

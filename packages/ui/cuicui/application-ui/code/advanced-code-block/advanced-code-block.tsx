  ...
  return (
    ...
    >
      ...
      <div className="w-full px-1 pb-1">
        <div className="relative isolate overflow-hidden rounded-xl border-white/80 border-t shadow-black/5 shadow-2xs dark:border-white/15 dark:shadow-black/10">
          <pre

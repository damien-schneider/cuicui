  ...
  return (
    <button
      className={cn(
        ...
        "before:-z-10 before:h-full before:rounded-md before:border before:border-neutral-500/5 before:bg-neutral-500/10 before:transition before:duration-200 before:ease-out before:active:bg-neutral-500/20 before:dark:border-neutral-600/10",
        // Dark mode

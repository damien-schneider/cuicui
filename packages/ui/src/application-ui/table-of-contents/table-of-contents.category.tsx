...
import { StepWithStickyColorVariant1 } from "@/src/application-ui/static-steppers/code/variant1";
import TableOfContentPreview from "@/src/application-ui/table-of-contents/modul-inspired/following-header-preview";

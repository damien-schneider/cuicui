...
import { ThreeDotSimpleLoader } from "@/src/common-ui/loaders/three-dot-simple-loader/three-dot-simple-loader"; // Allows to wait for the battery information to load
import { useBattery } from "@/src/hooks/use-battery/use-battery";

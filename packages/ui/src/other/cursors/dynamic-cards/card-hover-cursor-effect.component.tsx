...
import DynamicCardsVariant2 from "@/src/other/cursors/dynamic-cards/gradient-card-effect";
import DynamicCardsVariant1 from "@/src/other/cursors/dynamic-cards/only-border-card-effect";

...
export default function Dock() {
  return (
    <div className="relative w-full">
      <div className="max-w-full pt-4 mx-auto absolute bottom-0 left-1/2 -translate-x-1/2">
        <div className="relative ">
          <div className="absolute bottom-0 left-0 right-0 h-[80px] max-w-full rounded-3xl border dark:border-gray-600/60 dark:bg-gray-800/60 bg-gray-200/60 border-gray-200/60 z-10 pointer-events-none shadow-sm" />
...
function AppIcon({
  ...
  return (
    <div className=" p-2 pl-0 grid place-items-center cursor-pointer group transition-all duration-700  z-20 w-fit">
      <div
        className={cn(
          "size-16 group-hover:size-[4.75rem] transition-all duration-200 rounded-2xl inline pointer-events-none z-20 overflow-hidden group-hover:shadow-sm  shadow-inner bg-white dark:bg-gray-800",

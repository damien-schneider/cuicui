...
export default function BeforeEffectButtonVariant2() {
  return (
    <button
      type="button"
      className="px-3 relative py-2 before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-neutral-500/5 before:rounded-lg before:scale-90 before:hover:scale-100 before:opacity-0 before:hover:opacity-100 before:transition-all  before:-z-10 text-neutral-600  transition-colors dark:text-neutral-400 before:ease-out before:duration-200 before:active:bg-neutral-500/10 before:border before:border-neutral-500/5 before:dark:border-neutral-600/10 transform-gpu before:transform-gpu"
    >

...
export function ShinyGradientSkeletonVariant2() {
  return (
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "shimmer",
          "before:bg-gradient-to-b before:from-transparent before:via-white/50 dark:before:via-rose-100/10 before:to-transparent before:absolute before:inset-0",
